...
{/if}
    ...
    <link rel="stylesheet" href="//{$wptheme.wp_google_link}" type="text/css" media="all" />
    <link rel="stylesheet" href="//{$wptheme.wp_google_link2}" type="text/css" media="all" />

    {if isset($wptheme.wpstyleswitchercss)}
    <link href="{$wptheme.wpstyleswitchercss}{if isset($wptheme.wpcssstamp)}{$wptheme.wpcssstamp}{/if}" rel="stylesheet" type="text/css" media="all" />
    {/if}
