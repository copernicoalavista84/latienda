	...
	<div class="primary_block row">
		...
		<div class="pb-right-column col-md-6">
			...
			<p id="product_manufacturer">
				...
				<a href="{$link->getmanufacturerLink($product_manufacturer->id_manufacturer, $product_manufacturer->link_rewrite)|escape:'html':'UTF-8'}" title="{$product->manufacturer_name|escape:'html':'UTF-8'}">{$product->manufacturer_name|escape:'html':'UTF-8'}</a>
			</p>
			{/if}
			...
			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
				...
				<div class="product_attributes clearfix">
					...
					<p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
						<label for="quantity_wanted" class="attribute_label">{l s='Quantity'} :</label>
				...
				<div class="box-info-product">
					...
					<div class="box-cart-bottom">
						...
						{if !$content_only}{if isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS}{$HOOK_PRODUCT_ACTIONS}{/if}{/if}
