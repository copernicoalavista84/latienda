...
<div id="layered_block_left" class="block">
									...
									{if $filter.type == $filter_type && isset($filter.values)}
										{if isset($filter.slider)}
											{if $smarty.foreach.f_values.first}
												<li>
													<a href="#" data-rel="layered_{$filter.type}_slider" title="{l s='Cancel' mod='blocklayered'}"><i class="fa fa-times"></i></a>
													{if $filter.format == 1}
	...
	<div id="layered_ajax_loader" style="display: none;">
		<p>
			<i class="fa fa-spinner fa-spin fa-2x"></i> {l s='Loading...' mod='blocklayered'}
		</p>
	</div>
</div>
{else}
