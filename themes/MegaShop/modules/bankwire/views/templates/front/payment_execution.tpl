...
<h3 class="subheading">{l s='Bank-wire payment' mod='bankwire'}</h3>
...
<p class="cart_navigation" id="cart_navigation">
	<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html'}" class="std-btn"><i class="fa fa-chevron-left left"></i>{l s='Other payment methods' mod='bankwire'}</a>
	<input type="submit" style="float:right;" value="{l s='I confirm my order' mod='bankwire'}" class="exclusive_large" />
</p>
</form>
{/if}
