...
{else}
	{foreach name=wl from=$wishlists item=wishlist}
		...
		<p class="buttons_bottom_block">
			<a id="wishlist_button" tabindex="0" data-toggle="popover" data-trigger="focus" title="Wishlist" data-placement="bottom"><i class="fa fa-heart left"></i>{l s='Add to wishlist' mod='blockwishlist'}</a></p>
