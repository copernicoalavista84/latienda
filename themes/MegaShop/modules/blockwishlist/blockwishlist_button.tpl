...
<div class="wishlist">
	{foreach name=wl from=$wishlists item=wishlist}
		{if $smarty.foreach.wl.first}
			<a class="wishlist_button_list simptip" tabindex="0" data-toggle="popover" data-trigger="focus" data-tooltip="{l s='Wishlist' mod='blockwishlist'}" data-placement="bottom"><i class="fa fa-heart"></i></a>
