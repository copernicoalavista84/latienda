...
<div id="mailalerts_block_account" class="block">
	...
	<ul class="footer_links clearfix">
		<li><a class="std-btn" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}"><i class="fa fa-chevron-left left"></i> {l s='Back to Your Account' mod='mailalerts'}</a></li>
	</ul>
</div>
