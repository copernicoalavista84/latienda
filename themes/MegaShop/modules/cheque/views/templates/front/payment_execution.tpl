...
<h3 class="subheading">{l s='Check payment' mod='cheque'}</h3>
<form action="{$link->getModuleLink('cheque', 'validation', [], true)|escape:'html'}" method="post">
	...
	<p class="cart_navigation" id="cart_navigation">
		<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html'}" class="std-btn"><i class="fa fa-chevron-left left"></i>{l s='Other payment methods' mod='cheque'}</a>
		<input type="submit" style="float:right;" value="{l s='I confirm my order' mod='cheque'}" class="exclusive_large" />
	</p>
</form>
{/if}
