...
<div id="favoriteproducts_block_account">
	...
	<ul class="footer_links clearfix">
		<li><a class="std-btn" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}"><i class="fa fa-chevron-left left"></i> {l s='Back to your account' mod='favoriteproducts'}</a></li>
	</ul>
</div>