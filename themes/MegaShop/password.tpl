...
<ul class="clearfix footer_links">
	<li><a class="std-btn" href="{$link->getPageLink('authentication')|escape:'html':'UTF-8'}" title="{l s='Back to Login'}" rel="nofollow"><i class="fa fa-chevron-left left"></i>{l s='Back to Login'}</a></li>
</ul>
