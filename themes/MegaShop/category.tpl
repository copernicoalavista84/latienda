                ...
                <li class="col-xs-6 col-sm-4 col-md-3">
                    <div class="subcategory-content">
                        <div class="subcategory-image">
                            ...
                            {else}
                                <img class="replace-2x" src="{$img_cat_dir}{$lang_iso}-default-category_default.jpg" alt="{$subcategory.name|escape:'html':'UTF-8'}" width="{$categorySize.width}" height="{$categorySize.height}" />
                            {/if}
                        </a>
                        </div>
