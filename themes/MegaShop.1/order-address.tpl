...
{else}
	...
	<h1 class="page-heading step-num">1. {l s='Addresses'}</h1>
	<div id="opc_account" class="opc-main-block box">
...
<div class="addresses clearfix">
	...
	<div class="row">
		<div class="col-xs-12 col-md-6"{if $cart->isVirtualCart()} style="display:none;"{/if}>
...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				<a href="{$link->getPageLink($back_order_page, true, NULL, "{if $back}back={$back}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="std-btn">
...
{capture}<a href="{$smarty.capture.addressUrlAdd}" title="{l s='Update' js=1}">{l s='Update' js=1}</a>{/capture}
