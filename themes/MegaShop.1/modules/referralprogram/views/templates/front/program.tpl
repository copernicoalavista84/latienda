...
<ul class="footer_links clearfix">
	<li><a class="std-btn" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}"><i class="fa fa-chevron-left left"></i> {l s='Back to Your Account' mod='referralprogram'}</a></li>
	<li><a class="std-btn" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}"><i class="fa fa-chevron-left left"></i> {l s='Home' mod='referralprogram'}</a></li>
</ul>
