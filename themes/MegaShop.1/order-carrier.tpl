...
{else}
	<div id="carrier_area" class="opc-main-block">
		<h1 class="page-heading step-num">2. {l s='Delivery methods'}</h1>
	...
	{else}
		...
		{if !$opc}
				<p class="cart_navigation clearfix">
					...
					{if !$is_guest}
						{if $back}
							<a href="{$link->getPageLink('order', true, NULL, "step=1&back={$back}{if $multi_shipping}&multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="std-btn">
								<i class="fa fa-chevron-left left"></i>
								{l s='Previous'}
							</a>
						{else}
							<a href="{$link->getPageLink('order', true, NULL, "step=1{if $multi_shipping}&multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="std-btn">
								<i class="fa fa-chevron-left left"></i>
								{l s='Previous'}
							</a>
						{/if}
					{else}
						<a href="{$link->getPageLink('order', true, NULL, "{if $multi_shipping}multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="std-btn">
							<i class="fa fa-chevron-left left"></i>
							{l s='Previous'}
						</a>
					{/if}
