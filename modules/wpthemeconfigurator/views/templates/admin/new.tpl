...
<div class="new-item">
	<div class="form-group">
		<button type="button" class="btn btn-default btn-lg button-new-item"><i class="icon-plus-sign"></i> {l s='Add item' mod='wpthemeconfigurator'}</button>
	</div>
		...
		<form method="post" action="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
			<div class="well">
				<div class="language item-field form-group">
					<label class="control-label col-lg-3">{l s='Language' mod='wpthemeconfigurator'}</label>
					<div class="col-lg-7">
				...
				<div class="title item-field form-group">
					<label class="control-label col-lg-3 ">{l s='Title' mod='wpthemeconfigurator'}</label>
					<div class="col-lg-7">
					...
					<div class="col-lg-9 col-lg-offset-3">
						<div class="checkbox">
							<label class="control-label">
								{l s='Use title in front' mod='wpthemeconfigurator'}
				...
				<div class="hook item-field form-group">
					<label class="control-label col-lg-3">{l s='Hook' mod='wpthemeconfigurator'}</label>
					<div class="col-lg-7">
						<select class="form-control fixed-width-lg" name="item_hook" default="home">
							<option value="home">home</option>  
							<option value="wpbanner">wpbanner</option>							
				...
				<div class="image item-field form-group">
					<label class="control-label col-lg-3">{l s='Image' mod='wpthemeconfigurator'}</label>
					<div class="col-lg-7">
				...
				<div class="image_w item-field form-group">
					...
					<div class="col-lg-7">
						<div class="input-group fixed-width-lg">
							<span class="input-group-addon">{l s='px' mod='wpthemeconfigurator'}</span>
				...
				<div class="url item-field form-group">
					<label class="control-label col-lg-3">{l s='URL' mod='wpthemeconfigurator'}</label>
					<div class="col-lg-7">
				...
				<div class="target item-field form-group">
					<div class="col-lg-9 col-lg-offset-3">
						<div class="checkbox">
							<label class="control-label">
								{l s='Target blank' mod='wpthemeconfigurator'}
				...
				<div class="html item-field form-group">
					<label class="control-label col-lg-3">{l s='HTML' mod='wpthemeconfigurator'}</label>
					<div class="col-lg-7">
				...
				<div class="form-group">
					<div class="col-lg-7 col-lg-offset-3">
						...
						<button type="button" class="btn btn-default button-new-item-cancel"><i class="icon-remove"></i> {l s='Cancel' mod='wpthemeconfigurator'}</button>
						<button type="submit" name="newItem" class="button-new-item-save btn btn-default pull-right" onClick="this.form.submit();"><i class="icon-save"></i> {l s='Save' mod='wpthemeconfigurator'}</button>
					</div>
				</div>
			</div>
		</form>
