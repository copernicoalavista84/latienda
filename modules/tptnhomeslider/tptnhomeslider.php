...
class TptnHomeSlider extends Module
{
	...
	public function hookdisplayHeader($params)
	{
		if (!isset($this->context->controller->php_self) || $this->context->controller->php_self != 'index')
			return;
		$this->context->controller->addCSS($this->_path.'views/css/tptnslider.css');
		$this->context->controller->addJS($this->_path.'views/js/tptnslider.js');
	
		$config = $this->getConfigFieldsValues();
		$slider = array(
			'play' => $config['TPTNSLIDER_PLAY'] == '1' ? 'true' : 'false',
			'speed' => $config['TPTNSLIDER_SPEED']
		);
			...
			'form' => array(
				...
				'input' => array(
					array(
						...
						'required' => true,
						'lang' => true,
						'desc' => $this->l('Recommended width: 850 pixels')
					),
					array(
						'type' => 'text',
			...
			'form' => array(
				...
				'input' => array(
					...
					array(
						...
						'desc' => 'Switching time between two slides. Works only if, Auto play = YES',
						'suffix' => 'milliseconds'
					)
				),
				'submit' => array(
