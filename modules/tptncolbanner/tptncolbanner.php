...
class TptnColBanner extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Column Banners');
	...
	public function getContent()
	{
		...
		elseif (Tools::isSubmit('addSlide') || (Tools::isSubmit('id_slide') && $this->slideExists((int)Tools::getValue('id_slide'))))
		{
			...
			{
				$associated_shop_ids = TptnColBan::getAssociatedIdsShop((int)Tools::getValue('id_slide'));
	...
	protected function _prepareHook()
	{
		if (!$this->isCached('tptncolbanner.tpl', $this->getCacheId()))
		{
			...
			$this->smarty->assign(array('tptncolbanner_slides' => $slides));
		}
	...
	public function renderList()
	{
		...
		foreach ($slides as $key => $slide)
		{
			...
			$associated_shop_ids = TptnColBan::getAssociatedIdsShop((int)$slide['id_slide']);
			...
			'form' => array(
				...
				'input' => array(
					array(
						...
						'required' => true,
						'lang' => true,
						'desc' => $this->l('Recommended width: 260 pixels')
					),
					array(
						'type' => 'text',
	...
	protected function getWarningMultishopHtml()
	{
		if (Shop::getContext() == Shop::CONTEXT_GROUP || Shop::getContext() == Shop::CONTEXT_ALL)
			return '<p class="alert alert-warning">'.
						$this->l('You cannot manage banners from a "All Shops" or a "Group Shop" context, select directly the shop you want to edit').
					'</p>';
		else
			return '';
	}
