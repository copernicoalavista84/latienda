...
class TptnMobileMenu extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Mobile Menu');
		$this->description = $this->l('Adds a menu in header for mobiles/tablets.');
	}
	...
	{
		$this->context->controller->addJS($this->_path.'views/js/tptnmobilemenu.js');
		$this->context->controller->addCSS($this->_path.'views/css/tptnmobilemenu.css');
	}
